...
var createNewTaskElement = function (taskString) {
  ...
  label.className = 'task__text task-name';

  //Each elements, needs appending
  checkBox.type = "checkbox";
  checkBox.className = "task__check"
  editInput.type = "text";
  editInput.className = "task__input task-name task-input";

  editButton.innerText = "Edit"; //innerText encodes special characters, HTML does not.
  editButton.className = "task__edit action-task";

  deleteButton.className = "task__delete action-task";
